...
% \item Developed a regression test-suite for the Google backend in GVfs.
...
\begin{tightemize}
    ...
    % \item Helped migration from a monolithic Oracle ATG (Java based) system to a Bulk-Head Design Pattern based architecture in node.js.
    ...
    % \item Contributed to seen improvements in performance from less than 15,000 to $\sim$ 90,000 concurrent users/hr on a single instance.
