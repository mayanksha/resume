...
% \photo{./profile.png}
\name{Mayank}{Sharma}
\position{ Undergraduate{\enskip\cdotp\enskip}Computer Science and Engineering}
\address{Indian Institute of Technology, Kanpur}
\mobile{(+91) 946-124-0034}
\email{mayanksha@(cse.)iitk.ac.in \quad\textbar\quad mayank8019@gmail.com}
\homepage{mayanksha.me}
\github{mayanksha}
\linkedin{mayanksha}
